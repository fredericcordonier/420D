...
proxy_t listeners_menu[0x100] = {
    [IC_DIALOGOFF] = proxy_dialog_exit, [IC_BUTTON_WHEEL] = proxy_wheel,
    [IC_BUTTON_DISP] = proxy_button,    [IC_BUTTON_SET] = proxy_button,
    [IC_BUTTON_RIGHT] = proxy_button,   [IC_BUTTON_LEFT] = proxy_button,
    [IC_BUTTON_DP] = proxy_button,      [IC_BUTTON_AV] = proxy_button,
};
...
button_t message2button[0x100] = {
    [IC_BUTTON_DISP] = BUTTON_DISP,   [IC_BUTTON_SET] = BUTTON_SET,
    [IC_BUTTON_UP] = BUTTON_UP,       [IC_BUTTON_DOWN] = BUTTON_DOWN,
    [IC_BUTTON_RIGHT] = BUTTON_RIGHT, [IC_BUTTON_LEFT] = BUTTON_LEFT,
    [IC_BUTTON_DP] = BUTTON_DP,       [IC_BUTTON_AV] = BUTTON_AV,
};
