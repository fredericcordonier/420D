...
static char *av_strings[][4] = {
    ...
    {"2.0", "2.2", "2.5", "2.5"}, {"2.8", "3.2", "3.5", "3.5"},
    {"4.0", "4.5", "4.5", "5.0"}, {"5.6", "6.3", "6.7", "7.1"},
    {"8.0", "9.0", "9.5", "10"},  {"11", "13", "13", "14"},
    {"16", "18", "19", "20"},     {"22", "25", "27", "29"},
    {"32", "36", "38", "40"},     {"45", "48", "52", "60"},
    {"64", "", "", ""},
};
...
ev_t ev_normalize(ev_t ec) {
    return ec +
           SIGN(ec) *
               ev_normalization[DPData.cf_explevel_inc_third][abs(EV_SUB(ec))];
}
...
av_t av_inc(av_t av) { return av_add(av, EV_STEP); }
...
tv_t tv_inc(tv_t tv) { return tv_add(tv, EV_STEP); }
