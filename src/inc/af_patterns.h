...
#define AF_PATTERN_SQUARE                                                      \
    AF_POINT_C | AF_POINT_TL | AF_POINT_TR | AF_POINT_BL | AF_POINT_BR

#define AF_PATTERN_TOP AF_POINT_T
#define AF_PATTERN_TOPTRIANGLE AF_POINT_T | AF_POINT_TL | AF_POINT_TR
#define AF_PATTERN_TOPDIAMOND                                                  \
    AF_POINT_T | AF_POINT_TL | AF_POINT_TR | AF_POINT_C
#define AF_PATTERN_TOPHALF                                                     \
    AF_POINT_T | AF_POINT_TL | AF_POINT_TR | AF_POINT_C | AF_POINT_L |         \
        AF_POINT_R

#define AF_PATTERN_BOTTOM AF_POINT_B
#define AF_PATTERN_BOTTOMTRIANGLE AF_POINT_B | AF_POINT_BL | AF_POINT_BR
#define AF_PATTERN_BOTTOMDIAMOND                                               \
    AF_POINT_B | AF_POINT_BL | AF_POINT_BR | AF_POINT_C
#define AF_PATTERN_BOTTOMHALF                                                  \
    AF_POINT_B | AF_POINT_BL | AF_POINT_BR | AF_POINT_C | AF_POINT_L |         \
        AF_POINT_R
...
#define AF_PATTERN_LEFTDIAMOND                                                 \
    AF_POINT_L | AF_POINT_TL | AF_POINT_BL | AF_POINT_C
#define AF_PATTERN_LEFTHALF                                                    \
    AF_POINT_L | AF_POINT_TL | AF_POINT_BL | AF_POINT_C | AF_POINT_T |         \
        AF_POINT_B

#define AF_PATTERN_RIGHT AF_POINT_R
#define AF_PATTERN_RIGHTTRIANGLE AF_POINT_R | AF_POINT_TR | AF_POINT_BR
#define AF_PATTERN_RIGHTDIAMOND                                                \
    AF_POINT_R | AF_POINT_TR | AF_POINT_BR | AF_POINT_C
#define AF_PATTERN_RIGHTHALF                                                   \
    AF_POINT_R | AF_POINT_TR | AF_POINT_BR | AF_POINT_C | AF_POINT_T |         \
        AF_POINT_B
...
#define AF_PATTERN_ALL                                                         \
    AF_POINT_C | AF_POINT_T | AF_POINT_B | AF_POINT_TL | AF_POINT_TR |         \
        AF_POINT_BL | AF_POINT_BR | AF_POINT_L | AF_POINT_R
